/**
	...
	`CFFGLPluginInfo` that Toolpath.cpp registers at static-initialisation time.
	...
	binary: which build it is.
		...
		strings Toolpath.bundle/Contents/MacOS/Toolpath | grep toolpath
*/

extern "C" const char* ToolpathBuildStamp()
{
	return "toolpath " TOOLPATH_VERSION " built " __DATE__ " " __TIME__;
}
